            ...
            <div className="flex items-end gap-2">
                ...
                <div className="flex-1 relative">
                    <textarea
                        ...
                        disabled={disabled}
                        rows={1}
                        className="w-full px-4 py-2.5 bg-gray-100 border-0 rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-primary text-sm placeholder:text-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
