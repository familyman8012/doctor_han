...
export default function ReviewPolicyPage() {
    return (
        <article className="prose prose-gray max-w-none">
            <h1 className="text-2xl font-bold text-content-primary mb-6">리뷰 정책</h1>
            ...
            <section className="space-y-4">
                <h2 className="text-lg font-semibold text-content-primary">제1조 (리뷰 작성 자격)</h2>
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제2조 (리뷰 작성 기준)</h2>
                <p className="text-gray-700 leading-relaxed">
                    리뷰는 다음 기준에 따라 작성되어야 합니다.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-medium text-content-primary mb-2">작성 가능한 내용</h3>
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제3조 (리뷰 노출 정책)</h2>
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                    <li>
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제4조 (블라인드 처리 기준)</h2>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제5조 (리뷰 신고)</h2>
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                    <li>
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제6조 (신고 처리 절차)</h2>
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                    <li>
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제7조 (리뷰 수정 및 삭제)</h2>
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                    <li>
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제8조 (이의 신청)</h2>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제9조 (정책 변경)</h2>
                <p className="text-gray-700 leading-relaxed">
