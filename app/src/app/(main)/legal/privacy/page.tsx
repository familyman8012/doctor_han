...
export default function PrivacyPage() {
    return (
        <article className="prose prose-gray max-w-none">
            <h1 className="text-2xl font-bold text-content-primary mb-6">개인정보처리방침</h1>
            ...
            <section className="space-y-4">
                <h2 className="text-lg font-semibold text-content-primary">제1조 (수집하는 개인정보 항목)</h2>
                <p className="text-gray-700 leading-relaxed">
                    회사는 서비스 제공을 위해 다음과 같은 개인정보를 수집합니다.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-medium text-content-primary mb-2">필수 수집 항목</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mt-4">
                    <h3 className="font-medium text-content-primary mb-2">한의사 회원 추가 수집 항목</h3>
                    <ul className="list-disc list-inside space-y-1 text-gray-700">
                        <li>한의사 면허번호</li>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mt-4">
                    <h3 className="font-medium text-content-primary mb-2">업체 회원 추가 수집 항목</h3>
                    <ul className="list-disc list-inside space-y-1 text-gray-700">
                        <li>사업자등록번호</li>
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제2조 (개인정보의 수집 및 이용목적)</h2>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제3조 (개인정보의 보유 및 이용기간)</h2>
                <p className="text-gray-700 leading-relaxed">
                    회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.
                    단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-medium text-content-primary mb-2">관련 법령에 의한 보존</h3>
                    <ul className="list-disc list-inside space-y-1 text-gray-700">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제4조 (개인정보의 파기절차 및 방법)</h2>
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제5조 (개인정보의 제3자 제공)</h2>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제6조 (이용자의 권리와 행사방법)</h2>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제7조 (개인정보의 안전성 확보조치)</h2>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제8조 (개인정보 보호책임자)</h2>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section className="space-y-4 mt-8">
                <h2 className="text-lg font-semibold text-content-primary">제9조 (개인정보처리방침의 변경)</h2>
                <p className="text-gray-700 leading-relaxed">
