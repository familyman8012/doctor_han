  ...
  public: {
    Tables: {
      ...
      product_recent_views: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_recent_views_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "product_recent_views_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      refund_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "refund_requests_lead_charge_id_fkey"
            columns: ["lead_charge_id"]
            isOneToOne: true
            referencedRelation: "lead_charges"
            referencedColumns: ["id"]
          },
          {
    ...
    Functions: {
      ...
      create_settlement_with_items: {
        Args: {
          p_ad_purchase_revenue?: number
          p_bid_commission_revenue?: number
          p_items?: Json
          p_lead_charge_refunds?: number
          p_lead_charge_revenue?: number
          p_membership_revenue?: number
          p_net_revenue?: number
          p_period_end: string
          p_period_start: string
          p_status?: Database["public"]["Enums"]["settlement_status"]
          p_subscription_revenue?: number
          p_total_item_count?: number
    ...
    Enums: {
      ...
      settlement_item_type:
        ...
        | "ad_purchase"
        | "bid_commission"
      settlement_status: "pending" | "confirmed" | "paid"
