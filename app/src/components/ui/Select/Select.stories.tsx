...
export const WithPrefixLabel: Story = {
    render: () => <WithPrefixLabelRender />,
};

const WithStatusBadgeRender = () => {
    const [selectedOption, setSelectedOption] = useState<IOption | null>(null);
...
const ReactHookFormRender = () => {
    const { control, handleSubmit, watch } = useForm<ReactHookFormData>({
        defaultValues: {
            fruit: null,
...
const MultiSelectWithBadgesRender = () => {
    ...
    const formatStatus = (status: string) => {
        ...
        return (
            <Badge color={colors[status] as "blue" | "green" | "purple"} size="sm">
                {status}
            </Badge>
        );
    };
...
export const MultiSelectWithBadges: Story = {
    render: () => <MultiSelectWithBadgesRender />,
};

const WithUserProfilesRender = () => {
...
export const WithUserProfiles: Story = {
    render: () => <WithUserProfilesRender />,
};

const WithIconsAndCheckmarkRender = () => {
    const [selectedOption, setSelectedOption] = useState<IOption | null>(null);
...
export const WithIconsAndCheckmark: Story = {
    render: () => <WithIconsAndCheckmarkRender />,
};

const UsageExampleRender = () => {
