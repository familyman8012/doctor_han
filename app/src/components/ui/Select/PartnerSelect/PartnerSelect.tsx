        ...
        return partnerResponse.items.map((partner) => ({
            ...
            icon: (
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary/20">
                    <FaBuilding className="h-4 w-4 text-content-primary" />
                </div>
            ),
            data: partner, // 전체 파트너 데이터 저장
        }));
    }, [partnerResponse]);
        ...
        <div className={className}>
            ...
            <WindowedSelect
                ...
                onChange={(option: unknown) => {
                    ...
                    const partnerData = typedOption ? (typedOption as IOption & { data?: unknown }).data : null;
                    onChange?.(newValue, partnerData);
                }}
